...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        EstudianteBecado estudiante4 = new EstudianteBecado("Maria Jose", 24, "A080524", "programacion", 70.0);
        EstudianteInternacional estudiante5 = new EstudianteInternacional("Aurora Aknes Ramirez", 28, "A090807", "Ciencia", "Noruega");
